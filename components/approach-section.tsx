  ...
  const steps = [
    {
      ...
      description:
        "Call us or message on WhatsApp to pick a time that works for you. Morning and evening slots available.",
    },
    {
      number: "02",
      title: "Your First Consultation",
      description:
        "We take the time to understand your dental history, concerns, and goals—no rushing, no pressure.",
    },
    {
      number: "03",
      title: "Personalised Treatment Plan",
      description:
        "Every patient is different. We create a tailored plan that fits your needs and your budget.",
    },
    {
      number: "04",
      title: "Comfortable Treatment",
      description:
        "Our gentle approach and experienced hands ensure every procedure is as comfortable as possible.",
    },
    {
      number: "05",
      title: "Ongoing Care & Checkups",
      description:
        "We don't just treat—we maintain. Regular checkups keep your smile healthy for life.",
    },
  ]

  return (
    <section className="py-24 px-6 bg-background" id="process">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          >
            A caring process designed to make your dental experience comfortable and effective
          </motion.p>
        </div>
